...
!......eventually, declare some variables...............................
      ...
      contains
      subroutine read_lambda(dir,ifile,nr,nn,lambda,e,de)
      implicit none
...
!.....specify file and open for reading.................................
      filename_lambda = trim(dir)//'/lambda1d'//cfile//'.d'

      open(2,file=trim(filename_lambda),status='old')
...
!.....read in the energy bins...........................................
      ...
      do it=1,nn
        do ir=1,nr
          read(2,22) i,i,lambda(it,1:ne,ir)
        end do
      end do
      write(*,*) "Lambda read-in success for iter#:",ifile
...
22    format(2i6,20es12.4)
      ...
      end module readin_lambda_module
